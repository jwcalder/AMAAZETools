 ...
 *
 *  Computes spherical volume invariant, principal curvatures, and principal directions using method from
 *
 ...
 *
 *  Author: Jeff Calder, Riley O'Neill, 2020
 *
 */
...
static struct PyModuleDef cModPyDem =
{
   ...
   "svipca_module", "Some documentation",
   -1,
   SVIMethods
};

PyMODINIT_FUNC
PyInit_svipca_module(void)
{
   import_array();
...
/* Python version 2 */
PyMODINIT_FUNC
initsvipca_module(void)
{
   (void) Py_InitModule("svipca_module", SVIMethods);
